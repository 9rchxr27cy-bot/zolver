              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div
                    ...
                    className={`relative overflow-hidden rounded-2xl border-2 transition-all cursor-pointer group ${formData.selectedPlan === 'premium'
                  ...
                  <div
                    ...
                    className={`p-4 rounded-xl border-2 cursor-pointer flex justify-between items-center transition-all ${formData.selectedPlan === 'basic'
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1">
                <label className="text-xs font-bold uppercase text-slate-500 ml-1">{t.email}</label>
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className="w-full px-4 py-3 rounded-xl border-2 border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 focus:border-orange-500 focus:outline-none transition-colors font-medium"
                  placeholder="name@example.com"
                />
              </div>
              <div className="space-y-1">
                <label className="text-xs font-bold uppercase text-slate-500 ml-1">{t.password}</label>
                <input
                  type="password"
                  value={password}
              ...
              <Button
                className="w-full h-14 text-lg font-bold rounded-xl shadow-lg shadow-orange-500/20"
                disabled={loading}
              >
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
              <p className="text-slate-500 text-sm">
                ...
                <button onClick={() => { onClose(); onSignUpClick(); }} className="font-bold text-orange-500 hover:text-orange-600 transition-colors">
                  Sign Up
                </button>
              </p>
            </div>
